...
Public Class FrmUsuarios
    ...
    Private Function Validar() As Boolean
        ...
        If TxtIdUsuario.Text = Nothing And TxtContraseña.Text = Nothing And CboEstado.Text = Nothing And MtbIdEmpleado.Text = Nothing And CboTipoUsuario.Text = Nothing Then
        ...
        ElseIf TxtUsuario.Text = Nothing Then
            MessageBox.Show("Ingrese el nombre de usuario.", "DBSM", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Call HabilitarControles(False, True, False, True, True)
            TxtUsuario.Focus()
            estado = False
        ...
        ElseIf CboEstado.Text = Nothing Then
            MessageBox.Show("Seleccione el estado.", "DBSM", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Call HabilitarControles(False, True, False, True, True)
            CboEstado.Focus()
            estado = False
        ElseIf MtbIdEmpleado.Text = Nothing Then
            MessageBox.Show("Seleccione un código de empleado.", "DBSM", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Call HabilitarControles(False, True, False, True, True)
            MtbIdEmpleado.Focus()
            estado = False
        ElseIf CboTipoUsuario.Text = Nothing Then
            MessageBox.Show("Seleccione el tipo de usuario.", "DBSM", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Call HabilitarControles(False, True, False, True, True)
