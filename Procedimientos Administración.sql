...
--Asignacion Programa
---INSERTAR---
Create Trigger InsertarAsignacion

On [dbo].[AsignacionPrograma]
...
from [dbo].[AsignacionPrograma]
where [IdSoftware] = (select [IdSoftware] from inserted)
End

-------UPDATE------

Create Trigger ActualizarAsignacion
...
--Computadora
---INSERTAR---
Create Trigger InsertarComputadora
...
from [dbo].[Computadora]
where [NumComputadora] = (select [NumComputadora] from inserted)
End

-------UPDATE------

Create Trigger ActualizarComputadora
...
--Precedimiento de Log de Auditoria

Create Procedure Sp_LogAuditoria
As
Begin
	Set nocount on
